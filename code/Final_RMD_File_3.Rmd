...
We completed this analysis with R, version 4.1.2. We relied on several elements from the tidyverse \cite{wickhamtidyverse}, tidymodels \cite{Kuhn20}, rsample \cite{silge21}, recipes \cite{kuhn21}, and glmnet \cite{friedman10} packages in our analysis. As aforementioned, we used data from the United Nations Food and Agriculture Organization (FAO) and World Bank to address our research question. We obtained this data through the R4DS Tidy Tuesday repository (Global Fishing), which featured this dataset from Our World in Data's analysis "Fish and Overfishing" using data from FAO's database FAOSTAT.
